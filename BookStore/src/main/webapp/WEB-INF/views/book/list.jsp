...
<body>
	<div class="container">
				...
				<tbody>
					...
					<c:forEach var="item" items="${list}">						
						<tr>
							...
							<td><a href="update?bookid=${item.bookid}" class="btn btn-sm btn-warning">변경</a> <a href="delete?bookid=${item.bookid}" class="btn btn-sm btn-danger">삭제</a></td>
						</tr>
					</c:forEach>
				</tbody>
		...
		<div>
			<a href="dummy" class="btn btn-sm btn-secondary mt-2">대량 추가</a>
		</div>
		<div>
			<a href="init" class="btn btn-sm btn-danger mt-2">초기화</a>
		</div>
		<div>
